...
namespace Ateliex.Modules.Decisoes.Comerciais.ConsultaDePlanosComerciais
{
    public partial class PlanosComerciaisWindow
    {
        ...
        public PlanosComerciaisWindow(IConsultaDePlanosComerciais consultaDePlanosComerciais, IConsultaDeModelos consultaDeModelos)
        {
            InitializeComponent();
