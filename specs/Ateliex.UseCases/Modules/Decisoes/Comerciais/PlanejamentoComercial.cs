...
{
    public interface PlanejamentoComercial
    {
        void CriaPlano(PlanoComercial solicitacao);

        void AdicionaCustoDePlanoComercial(Custo solicitacao);

        void AdicionaItemDePlanoComercial(ItemDePlanoComercial solicitacao);
